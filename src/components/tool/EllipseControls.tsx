  ...
  return (
    <>
      <div className="control-row">
        <label>Width blocks<input type="number" min={1} max={1024} value={state.width} onChange={(event) => update('width', parseNumber(event.target.value, 31))} /></label>
        <label>Height blocks<input type="number" min={1} max={1024} value={state.height} onChange={(event) => update('height', parseNumber(event.target.value, 21))} /></label>
      </div>
      <div className="control-row">
