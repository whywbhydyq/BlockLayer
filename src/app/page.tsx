...
export const metadata: Metadata = {
  ...
  description:
    'Generate Minecraft circle blueprints with row segments, block counts, center guides, PNG/SVG/CSV export, print, share links, plus oval, sphere, and dome tools.',
