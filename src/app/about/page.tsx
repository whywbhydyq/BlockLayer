...
export default function Page() { return <main id="main" className="page-wrap"><section className="hero"><h1>About BlockLayer</h1><p>BlockLayer is a free client-side blueprint tool for Minecraft-style block builds. It focuses on practical building workflows: dimensions, layers, row segments, material counts, exports, and printing.</p></section></main>; }
